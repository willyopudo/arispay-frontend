...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'apps-company-account-list': RouteRecordInfo<'apps-company-account-list', '/apps/company/account/list', Record<never, never>, Record<never, never>>,
    'apps-company-account-view-id': RouteRecordInfo<'apps-company-account-view-id', '/apps/company/account/view/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
