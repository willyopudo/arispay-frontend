...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'apps-company-client-list': RouteRecordInfo<'apps-company-client-list', '/apps/company/client/list', Record<never, never>, Record<never, never>>,
    'apps-company-client-view-id': RouteRecordInfo<'apps-company-client-view-id', '/apps/company/client/view/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'apps-transaction-bulk-payments-list': RouteRecordInfo<'apps-transaction-bulk-payments-list', '/apps/transaction/bulk-payments/list', Record<never, never>, Record<never, never>>,
    'apps-transaction-bulk-payments-view-id': RouteRecordInfo<'apps-transaction-bulk-payments-view-id', '/apps/transaction/bulk-payments/view/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apps-transaction-rejected-transactions-list': RouteRecordInfo<'apps-transaction-rejected-transactions-list', '/apps/transaction/rejected-transactions/list', Record<never, never>, Record<never, never>>,
    'apps-transaction-rejected-transactions-view-id': RouteRecordInfo<'apps-transaction-rejected-transactions-view-id', '/apps/transaction/rejected-transactions/view/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apps-transaction-successful-transactions-list': RouteRecordInfo<'apps-transaction-successful-transactions-list', '/apps/transaction/successful-transactions/list', Record<never, never>, Record<never, never>>,
    'apps-transaction-successful-transactions-view-id': RouteRecordInfo<'apps-transaction-successful-transactions-view-id', '/apps/transaction/successful-transactions/view/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apps-transaction-transaction-query-list': RouteRecordInfo<'apps-transaction-transaction-query-list', '/apps/transaction/transaction-query/list', Record<never, never>, Record<never, never>>,
    'apps-transaction-transaction-query-view-id': RouteRecordInfo<'apps-transaction-transaction-query-view-id', '/apps/transaction/transaction-query/view/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'pages-authentication-set-password': RouteRecordInfo<'pages-authentication-set-password', '/pages/authentication/set-password', Record<never, never>, Record<never, never>>,
